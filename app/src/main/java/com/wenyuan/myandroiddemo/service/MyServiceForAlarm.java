...
public class MyServiceForAlarm extends Service {
    ...
    public MyServiceForAlarm() {
        KLog.d("MyServiceForAlarm()");
    }
    ...
    public void onCreate() {
        super.onCreate();
        KLog.d("onCreate()");
        sendBroadcast(new Intent("com.wenyuan.broadcastrecall.static"));
    }
    ...
    public class MyServiceBind extends Binder {
        public MyServiceForAlarm getService() {
            //返回当前服务
            return MyServiceForAlarm.this;
        }
    }
}
