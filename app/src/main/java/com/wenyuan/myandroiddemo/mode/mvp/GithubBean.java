...
/**
 * Created by wenyuan on 2017/2/12 17:35.
 * Description:
 *
 * id : 72290198
 * name : AndroidDemo
 * full_name : wenyuan1104/AndroidDemo
 * owner : {"login":"wenyuan1104","id":18169236,"avatar_url":"https://avatars.githubusercontent.com/u/18169236?v=3","gravatar_id":"","url":"https://api.github.com/users/wenyuan1104","html_url":"https://github.com/wenyuan1104","followers_url":"https://api.github.com/users/wenyuan1104/followers","following_url":"https://api.github.com/users/wenyuan1104/following{/other_user}","gists_url":"https://api.github.com/users/wenyuan1104/gists{/gist_id}","starred_url":"https://api.github.com/users/wenyuan1104/starred{/owner}{/repo}","subscriptions_url":"https://api.github.com/users/wenyuan1104/subscriptions","organizations_url":"https://api.github.com/users/wenyuan1104/orgs","repos_url":"https://api.github.com/users/wenyuan1104/repos","events_url":"https://api.github.com/users/wenyuan1104/events{/privacy}","received_events_url":"https://api.github.com/users/wenyuan1104/received_events","type":"User","site_admin":false}
 * private : false
 * html_url : https://github.com/wenyuan1104/AndroidDemo
 * description : 首次提交，数据加密第一次提交。
 * fork : false
 * url : https://api.github.com/repos/wenyuan1104/AndroidDemo
 * forks_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/forks
 * keys_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/keys{/key_id}
 * collaborators_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/collaborators{/collaborator}
 * teams_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/teams
 * hooks_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/hooks
 * issue_events_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/issues/events{/number}
 * events_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/events
 * assignees_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/assignees{/user}
 * branches_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/branches{/branch}
 * tags_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/tags
 * blobs_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/git/blobs{/sha}
 * git_tags_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/git/tags{/sha}
 * git_refs_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/git/refs{/sha}
 * trees_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/git/trees{/sha}
 * statuses_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/statuses/{sha}
 * languages_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/languages
 * stargazers_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/stargazers
 * contributors_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/contributors
 * subscribers_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/subscribers
 * subscription_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/subscription
 * commits_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/commits{/sha}
 * git_commits_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/git/commits{/sha}
 * comments_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/comments{/number}
 * issue_comment_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/issues/comments{/number}
 * contents_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/contents/{+path}
 * compare_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/compare/{base}...{head}
 * merges_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/merges
 * archive_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/{archive_format}{/ref}
 * downloads_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/downloads
 * issues_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/issues{/number}
 * pulls_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/pulls{/number}
 * milestones_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/milestones{/number}
 * notifications_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/notifications{?since,all,participating}
 * labels_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/labels{/name}
 * releases_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/releases{/id}
 * deployments_url : https://api.github.com/repos/wenyuan1104/AndroidDemo/deployments
 * created_at : 2016-10-29T14:40:37Z
 * updated_at : 2016-10-30T05:47:50Z
 * pushed_at : 2017-01-15T12:55:55Z
 * git_url : git://github.com/wenyuan1104/AndroidDemo.git
 * ssh_url : git@github.com:wenyuan1104/AndroidDemo.git
 * clone_url : https://github.com/wenyuan1104/AndroidDemo.git
 * svn_url : https://github.com/wenyuan1104/AndroidDemo
 * homepage : null
 * size : 3095
 * stargazers_count : 0
 * watchers_count : 0
...
public class GithubBean implements Parcelable {
    ...
    public static class OwnerBean implements Parcelable {
         ...
         * login : wenyuan1104
         * id : 18169236
         * avatar_url : https://avatars.githubusercontent.com/u/18169236?v=3
         * gravatar_id :
         * url : https://api.github.com/users/wenyuan1104
         * html_url : https://github.com/wenyuan1104
         * followers_url : https://api.github.com/users/wenyuan1104/followers
         * following_url : https://api.github.com/users/wenyuan1104/following{/other_user}
         * gists_url : https://api.github.com/users/wenyuan1104/gists{/gist_id}
         * starred_url : https://api.github.com/users/wenyuan1104/starred{/owner}{/repo}
         * subscriptions_url : https://api.github.com/users/wenyuan1104/subscriptions
         * organizations_url : https://api.github.com/users/wenyuan1104/orgs
         * repos_url : https://api.github.com/users/wenyuan1104/repos
         * events_url : https://api.github.com/users/wenyuan1104/events{/privacy}
         * received_events_url : https://api.github.com/users/wenyuan1104/received_events
         * type : User
         * site_admin : false
         */
    ...
    protected GithubBean(Parcel in) {
        this.id = in.readInt();
    ...
    public static final Parcelable.Creator<GithubBean> CREATOR = new Parcelable.Creator<GithubBean>() {
        @Override
