 ...
 * Service运行在主线程中
 */
public class MyServiceForBind extends Service {

    public MyServiceForBind() {
        KLog.d("MyServiceForBind()");
    }
    ...
    public class MyServiceBind extends Binder {
        public MyServiceForBind getService() {
            //返回当前服务
            return MyServiceForBind.this;
        }
    }
}
